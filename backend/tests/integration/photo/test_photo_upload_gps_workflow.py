...
class TestPhotoUploadGPSWorkflow:
    """Integration tests for photo upload with GPS extraction."""
...
class TestPhotoUploadAPIWorkflow:
    """Test photo upload via API with GPS processing."""
    ...
    async def test_api_upload_override_location(
        ...
        with patch(
            ...
            response = authenticated_client.post(
                "/api/photos",
                files={
                    "file": ("test_override.jpg", test_image_with_gps, "image/jpeg")
                },
                data={
                    "title": "Override Test",
