...
class TestPhotosAPI:
    ...
    async def test_get_photos_returns_paginated_results(
        ...
        # Create test photos
        photos = await PhotoFactory.create_batch_async(test_session, 15)
    ...
    async def test_get_photos_with_tags_filter(
        ...
        city_photos = await PhotoFactory.create_batch_async(
            test_session, 3, tags=["city", "urban"]
        )
    ...
    async def test_get_photos_with_date_range_filter(
        ...
        recent_photos = await PhotoFactory.create_batch_async(
            test_session, 5,
    ...
    async def test_get_nonexistent_photo_returns_404(
