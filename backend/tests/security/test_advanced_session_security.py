...
class TestSecurityHeadersAndResponse:
    ...
    async def test_error_response_information_disclosure(
        ...
        for scenario in error_scenarios:
            ...
            assert not disclosure_analysis["content_disclosures"]["stack_traces"][
                "found"
            ]
    ...
    async def test_response_timing_consistency(
        ...
        if max_timing > 0:
            ...
            assert timing_ratio < 0.5, (
                f"Timing difference too large: {timing_ratio:.2%}"
            )
...
class TestSecurityPerformance:
    """Test security under performance conditions."""
