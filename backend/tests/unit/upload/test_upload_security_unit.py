...
class TestFileTypeValidation:
    ...
    def test_magic_number_file_header_validation(self, image_processor):
        ...
        for name, data in fake_image_data.items():
...
class TestFileSizeValidation:
    ...
    def test_disk_space_checking_before_upload(self, image_processor):
        ...
        with patch('shutil.disk_usage') as mock_disk_usage:
            ...
            mock_disk_usage.return_value = (1000, 1000, 10 * 1024 * 1024)  # Only 10MB free
...
class TestFilenameSanitization:
    ...
    def test_unicode_filename_handling(self):
        ...
        for filename in unicode_filenames:
            ...
            filesystem_safe = all(ord(c) < 128 or c.isalnum() or c in '.-_' for c in sanitized)
    ...
    def test_reserved_filename_handling(self):
        ...
        reserved_names = [
            ...
            "COM1.jpg", "COM2.jpg", "LPT1.jpg", "LPT2.jpg"
        ]
