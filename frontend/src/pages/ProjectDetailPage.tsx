...
const ProjectDetailPage: React.FC = () => {
  ...
  const content =
    (readme as ProjectReadmeResponse | undefined)?.content ??
    project.description;
              ...
              >
                ...
                <div>
                  ...
                  <dl className="space-y-2 text-sm">
                    ...
                    {(readme as ProjectReadmeResponse | undefined)
                      ?.last_updated && (
                      <div>
              ...
              <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-blue-800">
                    This content is automatically synced from the project's
                    README.md file on {(readme as ProjectReadmeResponse).source}
                    .
                  </span>
                </div>
              </div>
