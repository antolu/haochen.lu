...
import { useCreateLensAlias, useUpdateLensAlias, type LensAlias } from '../hooks/useLensAliases';
...
const LensAliasForm: React.FC<LensAliasFormProps> = ({ alias, onSuccess, onCancel }) => {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="p-6">
      <form onSubmit={e => void handleSubmit(e)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="mount_type" className="block text-sm font-medium text-gray-700 mb-1">
              Mount Type
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="focal_length" className="block text-sm font-medium text-gray-700 mb-1">
              Focal Length
            </label>
            <input
              type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="max_aperture" className="block text-sm font-medium text-gray-700 mb-1">
              Max Aperture
            </label>
            <input
              type="text"
              ...
              onChange={e => handleInputChange('max_aperture', e.target.value)}
          ...
          <div>
            <label htmlFor="lens_type" className="block text-sm font-medium text-gray-700 mb-1">
              Lens Type
            </label>
            <select
              id="lens_type"
