  ...
  return (
    <div className={className}>
      ...
      {repoInfo && (
        <div className="mt-2 p-3 bg-green-50 border border-green-200 rounded-lg">
          <div className="flex items-start">
            ...
            <div className="flex-1">
              <p className="text-sm text-green-800 font-medium mb-1">Repository Validated</p>
      ...
      <p className="mt-2 text-sm text-gray-500">
        Connect your GitHub or GitLab repository to automatically sync README content. Private
        repositories require authentication tokens configured on the server.
      </p>
    </div>
  );
};
