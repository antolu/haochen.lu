...
describe('ProjectDetailPage', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('displays project image when provided', () => {
      ...
      expect(projectImage).toHaveAttribute('src', 'https://example.com/project-image.jpg');
    ...
    it('displays fallback placeholder when image is not provided', () => {
      ...
      const placeholder = screen.getByText('Test Project').closest('section')?.querySelector('svg');
    ...
    it('shows featured badge when project is featured', () => {
      ...
      expect(featuredBadge).toHaveClass('bg-blue-100', 'text-blue-800', 'border-blue-200');
    });
  ...
  describe('Content Display', () => {
    ...
    it('does not show README indicator when using project description', () => {
      ...
      expect(screen.queryByText(/This content is automatically synced/)).not.toBeInTheDocument();
    });
  ...
  describe('Error Handling', () => {
    it('shows error state when project fetch fails', () => {
      ...
      expect(
        screen.getByText("The project you're looking for doesn't exist or has been removed.")
      ).toBeInTheDocument();
    });
    ...
    it('shows error icon in error state', () => {
      ...
      const errorIcon = screen.getByText('Project not found').closest('div')?.querySelector('svg');
  ...
  describe('URL Parameter Handling', () => {
    ...
    it('calls useProjectReadme with correct parameters', () => {
      ...
      expect(mockUseProjectReadme).toHaveBeenCalledWith(mockProject.id, mockProject.github_url);
    });
    ...
    it('does not call useProjectReadme when use_readme is false', () => {
      ...
      expect(mockUseProjectReadme).toHaveBeenCalledWith(mockProject.id, undefined);
    });
  });
  ...
  describe('Responsive Layout', () => {
    ...
    it('has responsive container classes', () => {
      ...
      const containers = document.querySelectorAll('.max-w-7xl.mx-auto, .max-w-4xl.mx-auto');
