...
describe('ProjectForm', () => {
  ...
  describe('Form Fields and Validation', () => {
    ...
    it('disables slug field in edit mode', () => {
      ...
      expect(screen.getByText('Slug cannot be changed after creation')).toBeInTheDocument();
    });
  ...
  describe('README Integration', () => {
    ...
    it('handles README preview', async () => {
      ...
      await waitFor(() => {
        expect(mockPreviewReadme).toHaveBeenCalledWith('https://github.com/test/project');
      });
    });
    ...
    it('changes description label when README is enabled', () => {
      ...
      const readmeCheckbox = screen.getByLabelText('Use README.md from repository');
  ...
  describe('Markdown Editor', () => {
    ...
    it('shows appropriate help text for markdown editor', () => {
      ...
      expect(
        screen.getByText(/Supports Markdown formatting including code blocks, links, and images/)
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Form Submission', () => {
    ...
    it('handles form submission errors gracefully', async () => {
      ...
      await waitFor(() => {
        expect(consoleSpy).toHaveBeenCalledWith('Failed to save project:', expect.any(Error));
      });
  ...
  describe('Loading States', () => {
    ...
    it('shows loading state during README preview', async () => {
      mockPreviewReadme.mockImplementation(() => new Promise(resolve => setTimeout(resolve, 100)));
  ...
  describe('User Interactions', () => {
    ...
    it('handles checkbox interactions', async () => {
      ...
      const featuredCheckbox = screen.getByLabelText('Mark as featured project');
      const readmeCheckbox = screen.getByLabelText('Use README.md from repository');
  ...
  describe('Edge Cases', () => {
    ...
    it('handles network errors during README preview', async () => {
      ...
      await waitFor(() => {
        expect(consoleSpy).toHaveBeenCalledWith('Failed to preview README:', expect.any(Error));
      });
