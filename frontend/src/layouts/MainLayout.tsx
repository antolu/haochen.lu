...
const MainLayout: React.FC = () => {
  ...
  const { data: subAppsData } = useQuery({
    ...
    queryFn: () =>
      isAuthenticated ? subapps.listAuthenticated() : subapps.list(),
  });
      ...
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-300 mb-4 max-w-md">
                Capturing moments through the lens, sharing stories through code
                and words. Passionate about photography, technology, and
                creative expression.
              </p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} Anton Lu. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
